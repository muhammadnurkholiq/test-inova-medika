...
<div class="form">
  ...
  <div class="row">
    ...
    <?php echo $form->dropDownList($model, 'action_id', ['0' => 'Silahkan pilih'] + CHtml::listData(Action::model()->findAll(), 'id', 'name'), ['class' => 'form-control']); ?>
    <?php echo $form->error($model, 'action_id'); ?>
  </div>

  <div class="row">
    <?php echo $form->labelEx($model, 'medicine_id'); ?>
    <?php echo $form->dropDownList($model, 'medicine_id', ['0' => 'Silahkan pilih'] + CHtml::listData(Medicine::model()->findAll(), 'id', 'name'), ['class' => 'form-control']); ?>
    <?php echo $form->error($model, 'medicine_id'); ?>
  </div>

  <div class="row buttons">
    <?php echo CHtml::submitButton('Create Transaction', ['class' => 'btn btn-primary']); ?>
