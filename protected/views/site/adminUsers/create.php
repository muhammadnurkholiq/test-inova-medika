...
<div class="form">
  ...
  <div class="row">
    ...
    <?php echo $form->dropDownList($model, 'role', ['admin' => 'Admin', 'employee' => 'Employee'], ['class' => 'form-control']); ?>
  ...
  <div class="row buttons">
    <?php echo CHtml::submitButton('Add User', ['class' => 'btn btn-primary']); ?>
    <?php echo CHtml::button('Back', [
